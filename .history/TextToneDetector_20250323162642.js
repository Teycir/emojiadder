...
class TextToneDetector {
  ...
  async initializeModel() {
    try {
      ...
      this.isModelLoaded = false; // Ensure flag is false during initialization
      
      await this.sentimentModel.initialize();
      
      // After initialization completes successfully, set the model loaded flag
      this.isModelLoaded = true;
      console.log('TextToneDetector: Model loaded successfully');
      
      // No longer directly manipulate UI elements from here
      // UI updates will be handled by script.js checking the isModelLoaded flag
    } catch (error) {
